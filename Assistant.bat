...
if %command2% == note echo Opening Note. && notecreator.bat && start /MIN python.exe ./sounds/main/note.py

:: Other Commands 2 (Applications)
if %command2% == matrix start matrix.bat && start /MIN python.exe ./sounds/apps/matrix.py
